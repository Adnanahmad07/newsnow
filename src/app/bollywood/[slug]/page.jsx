    ...
    useEffect(() => {
        const fetchArticle = async () => {
            try {
                ...
                const cachedArticles = JSON.parse(localStorage.getItem('bollywood-articles') || '[]');
                const cachedArticle = cachedArticles.find(a =>
                    encodeURIComponent(a.title) === params.slug
                );
                ...
                // Cache the articles
                localStorage.setItem('bollywood-articles', JSON.stringify(data.articles));
